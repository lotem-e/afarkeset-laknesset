...
// The derivation itself lives in derive-stages.mjs, shared with
// sync-all so the rich and the thin sync can never disagree.
...
async function main() {
  ...
  const completedDate = completedDateOf(milestones, bill.StatusID);
